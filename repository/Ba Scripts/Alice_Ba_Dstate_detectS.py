...
class Alice_Ba_Dstate_detectS(base_experiment.base_experiment):
    ...
    def build(self):
        ...
        self.setattr_argument('detection_time__scan', Scannable( default=[NoScan(1.5 * us), RangeScan(0*us, 3*self.globals__timing__detection_time, 10) ], global_min=0*us, global_step=1*us, unit='us', ndecimals=3))
        self.setattr_argument('delay_time__scan', Scannable(default=[NoScan(750), RangeScan(0, 1000, 10)], global_min=0, global_step=10, ndecimals=0))
    ...
    def run(self):
        ...
        initialparams = [800, 3e-6, 20]
        fitbounds = ([0,0, 0], [1200, 1000e-6, 100])
