""" Needs more testing 
Alice Yb state detection calibration
Does work. not able to pump to state 1

George Toh 2022-01-31
"""
...
class Alice_Yb_State_det_calib1(base_experiment.base_experiment):
    """ Alice Yb S-state detection calibration state1"""
    ...
    def build(self):
        ...
        self.scan_names = ['cooling_time', 'pumping_time', 'detection_time', 'delay_time', 'microwave_time', 'mw_freq', 'mw_amp']
        ...
        self.setattr_argument('microwave_time__scan', group = 'mw', processor = Scannable(default=[NoScan(1*us), RangeScan(0, 50*us, 10)], 
    ...
    def kernel_run(self):
        ...
        for i in range(self.detections_per_point):
            ...
            # Turn off all lasers before microwave
            self.ttl_370_2G_EOM.off()
            self.ttl_370_7G_EOM.off()
            self.ttl_370_AOM.off()
            self.ttl_935_EOM.off()
