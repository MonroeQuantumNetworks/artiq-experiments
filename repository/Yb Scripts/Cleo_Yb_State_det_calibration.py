""" 
Cleo Yb state detection calibration
Tested. Works. 

Isabella goetting 2022-05-23
"""
...
class Cleo_Yb_State_det_calib(base_experiment.base_experiment):
    """ Cleo Yb S-state detection calibration"""
