...
Cleo Yb 435 scan for calibrating 935 de-shelving time


George Toh 2022-05-26
"""
...
class Cleo_Yb_435_scan_pump2(base_experiment.base_experiment):
    """ Cleo Yb 435 Scan pump2"""
    ...
    def build(self):
        ...
        self.scan_names = ['cooling_time', 'pumping_time', 'pumping_time2', 'detection_time', 'delay_time', 'shelving_time', 'AOM435_frequency', 'AOM435_amplitude']
        ...
        self.setattr_argument('pumping_time2__scan', group = '370', processor = Scannable(default=[NoScan(self.globals__timing__pumping_time), 
                                RangeScan(0*us, 3*self.globals__timing__pumping_time, 10) ], global_min=0*us, global_step=1*us, unit='us', ndecimals=3))
    ...
    def record_pump_0(self):
        ...
        with self.core_dma.record("pulses0"):
            ...
            self.ttl_935_EOM.on()
            delay(self.pumping_time2)      # Try to de-shelve the ion
            self.ttl_935_EOM.off() 
