...
class Bob_Ba_Raman_Ramsey_AWG(base_experiment.base_experiment):
    ...
    def build(self):
        ...
        self.scan_names = ['cooling_time', 'pumping_time', 'raman_time', 'detection_time', 'delay_time', 'Ramsey_delay', 'Ramsey_phase', 'Raman_frequency', 'AWG__532__Bob__tone_1__amplitude', 'AWG__532__Bob__tone_2__amplitude']
    ...
    def prep_record(self):
        ...
        with self.core_dma.record("pulses_prep"):
            ...
            self.DDS__493__Bob__strong_sigma_1.sw.off() # Bob 493 sigma 1
            self.DDS__493__Bob__strong_sigma_2.sw.off() # Bob 493 sigma 2
