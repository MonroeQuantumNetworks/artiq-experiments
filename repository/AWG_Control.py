...
class AWG_Control(base_experiment.base_experiment):
    ...
    def build(self):
        ...
        self.setattr_argument('tone_1__frequency', NumberValue(80000000, ndecimals=9, min=1, step=1000000, unit = 'MHz'))
        self.setattr_argument('tone_2__frequency', NumberValue(83000000, ndecimals=9, min=1, step=1000000, unit = 'MHz'))
        ...
        self.setattr_argument('phase1', NumberValue(0, ndecimals=5, min=0, max = 300))
        self.setattr_argument('phase2', NumberValue(0, ndecimals=5, min=0, max=300))
        self.setattr_argument('phase3', NumberValue(0, ndecimals=5, min=0, max=300))
        ...
        try:
            ...
            if self.AWG_quit == True:
                ...
                sendmessage(self,
                            ...
                            frequency1 = self.tone_1__frequency,   # Hz
                            frequency2 = self.tone_2__frequency,   # Hz
                            phase1 = self.phase1,                                    # radians
                            phase2 = self.phase2,  # radians
                            phase3 = self.phase3,  # radians
