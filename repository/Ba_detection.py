...
class Ba_detection(base_experiment.base_experiment):
    ...
    def build(self):
        ...
        print('Ba_detection.py build() done')
    ...
    def detect1(self):
        t = now_mu()
        gate_end_mu = self.Bob_camera_side_APD.gate_rising(self.globals__timing__detection_time)
        at_mu(t)
        self.DDS__493__Bob__sigma_1.sw.on()
        delay(self.globals__timing__detection_time)
        self.DDS__493__Bob__sigma_1.sw.off()
