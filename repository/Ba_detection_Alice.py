...
class Ba_detection_Alice(base_experiment.base_experiment):
    ...
    def build(self):
        ...
        self.setattr_argument('DDS__493__Alice__sigma_1__frequency__scan', Scannable( default=[NoScan(self.globals__DDS__493__Bob__sigma_1__frequency), CenterScan(self.globals__DDS__493__Bob__sigma_1__frequency/MHz, 1, 0.1) ], unit='MHz', ndecimals=9))
        self.setattr_argument('DDS__493__Alice__sigma_2__frequency__scan', Scannable( default=[NoScan(self.globals__DDS__493__Bob__sigma_2__frequency), CenterScan(self.globals__DDS__493__Bob__sigma_2__frequency/MHz, 1, 0.1) ], unit='MHz', ndecimals=9))
    ...
    def cool(self):
        ...
        #self.DDS__493__Alice__cooling.sw.off()

    @kernel
    def pump1(self):
        self.DDS__493__Alice__sigma_1.sw.pulse(self.globals__timing__pumping_time)
    ...
    def kernel_run(self):
        ...
        delay(100*us)
        self.DDS__493__Alice__sigma_1.set(self.DDS__493__Alice__sigma_1__frequency, amplitude=self.DDS__493__Alice__sigma_1__amplitude)
        delay(100*us)
        self.DDS__493__Alice__sigma_2.set(self.DDS__493__Alice__sigma_2__frequency, amplitude=self.DDS__493__Alice__sigma_2__amplitude)
        delay(100 * us)
