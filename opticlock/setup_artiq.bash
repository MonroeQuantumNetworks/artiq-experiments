...
# for artiq 5:
#artiq_flash -t kasli -V monroe_ionphoton --srcbuild True -d ./artiq_kasli
...
artiq_flash -t kasli -V monroe_ionphoton --srcbuild ./artiq_kasli -f flash_storage.img storage start
